/**
 * The instanced-mesh component from https://github.com/diarmidmackenzie/instanced-mesh
 * Downloaded: February 13, 2025 (version for Sept 24, 2024)
 * npm package was not useable, so we downloaded the js version and wrapped the components to functions
 */

import "aframe";

export const registerInstancedMeshComponent = () => {
...
export const registerInstancedMeshMemberComponent= () => {
